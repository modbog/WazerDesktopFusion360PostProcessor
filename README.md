...
Maximum segment length for linear moves (mm): This propery governs how long G1 lines should be split into, which in turn governs how long the feedrate ramp down / ramp up schedule will be. WAM hardcodes a 5mm value for a similar property. Default value is 5mm.
